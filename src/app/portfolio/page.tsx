...
function WalletBadge({ wallet }: { wallet: typeof WALLETS[number] }) {
  ...
  return (
    <div className="flex items-center gap-2.5 px-3 py-2 bg-zinc-900/50 border border-zinc-700/40 rounded-full">
      <ChainIcon
...
function PerformanceChart() {
  ...
  return (
    <div className="bg-zinc-900/50 border border-zinc-700/40 rounded-2xl shadow-lg overflow-hidden h-full flex flex-col">
    ...
    <div className="min-h-screen bg-[#020408] font-[family-name:var(--font-geist-sans)]">
      ...
      <main className="max-w-[1600px] mx-auto px-6 sm:px-8 py-6 space-y-5">
        ...
        <div className="flex flex-col lg:flex-row gap-5">
          {/* Net Worth Card */}
          <div className="flex-1 lg:w-[65%] bg-zinc-900/50 border border-zinc-700/40 rounded-2xl p-6 shadow-lg">
          ...
          <div className="lg:w-[35%] min-w-[300px]">
            <div className="bg-zinc-900/50 border border-zinc-700/40 rounded-2xl p-6 shadow-lg h-full">
